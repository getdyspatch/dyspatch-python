...
class LocalizationRead(object):
    ...
    def __init__(self, id=None, language=None, url=None, template=None, compiled=None, created_at=None, updated_at=None, name=None, local_vars_configuration=None):  # noqa: E501
