...
from dyspatch_client.exceptions import ApiTypeError, ApiValueError, ApiException
from dyspatch_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DraftsApi()
        api_instance.delete_localization  # this is an instance of the class Endpoint
        api_instance.delete_localization()  # this invokes api_instance.delete_localization.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_localization.callable or self.callable in this class
