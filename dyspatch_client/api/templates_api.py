...
class TemplatesApi(object):
    ...
    def get_template_by_id(self, template_id, target_language, accept, **kwargs):  # noqa: E501
        ...
        :param str accept: A version of the API that should be used for the request. For example, to use version \"2019.10\", set the value to \"application/vnd.dyspatch.2019.10+json\" (required)
