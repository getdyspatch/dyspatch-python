...
from dyspatch_client.api import localizations_api
...
with dyspatch_client.ApiClient(configuration) as api_client:
    ...
    api_instance = localizations_api.LocalizationsApi(api_client)
    draft_id = "draftId_example" # str | A draft ID
    localization_id = "localizationId_example" # str | A localization ID
    ...
    try:
        # Get Draft Localization Object by ID
        api_response = api_instance.get_draft_localization_by_id(draft_id, localization_id, target_language, accept)
        pprint(api_response)
    except dyspatch_client.ApiException as e:
        print("Exception when calling LocalizationsApi->get_draft_localization_by_id: %s\n" % e)
```
...
with dyspatch_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Localization Object by ID
        api_response = api_instance.get_published_localization_by_id(localization_id, target_language, accept)
        pprint(api_response)
    except dyspatch_client.ApiException as e:
        print("Exception when calling LocalizationsApi->get_published_localization_by_id: %s\n" % e)
```
